...
class Scheduling extends Extension
{
    ...
    protected static function registerRoutes()
    {
        parent::routes(function ($router) {
            ...
            $router->get('scheduling', 'Jblv\Admin\Scheduling\SchedulingController@index')->name('scheduling-index');
            $router->post('scheduling/run', 'Jblv\Admin\Scheduling\SchedulingController@runEvent')->name('scheduling-run');
        });
    }
